...
J =: get_data_ptr =: 3 : 0"0 NB. y is af_array pointer
 NB.pD l=. (AFbytesize@get_type * num_elements) y
 NB.pD a =. mema l
 a =. (num_elements y) # AFpadval get_type y
 b =. 1 {::  af_get_data_ptr  a; y
 NB. memr (15!:14 <'b'),0,l,4
 NB. memr b,0,l,4
 (dims y) $ b
)
